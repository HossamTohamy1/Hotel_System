...
namespace Hotel.Infrastructure.Migrations
{
    ...
    [Migration("20250618140405_AddRoomaAtruibuteAndAdsTables")]
    partial class AddRoomaAtruibuteAndAdsTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Hotel.Core.Entities.RoomConnection", b =>
                {
                    b.HasOne("Hotel.Core.Entities.Room", "Room1")
                        .WithMany("ConnectedRooms1")
                        .HasForeignKey("RoomId1")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Hotel.Core.Entities.Room", "Room2")
                        .WithMany("ConnectedRooms2")
            ...
            modelBuilder.Entity("Hotel.Core.Entities.Room", b =>
                {
                    ...
                    b.Navigation("ConnectedRooms1");

                    b.Navigation("ConnectedRooms2");
